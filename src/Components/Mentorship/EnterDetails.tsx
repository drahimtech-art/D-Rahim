function EnterDetails() {
  return (
    <div className=" mt-27.25 pl-10 pr-10">
      ...
      <div className="mt-15 flex flex-col w-201.75 gap-1.5">
        <span className=" font-inter">
          <h5 className="text-[24px] font-inter font-medium">Full Name</h5>
          <input className="border-b-2 border-gray-600 w-full  pb-7 mt-7"></input>
        </span>
        <span className=" font-inter">
          <h5 className="text-[24px] font-inter font-medium">Email Address</h5>
          <input className="border-b-2 border-gray-600 w-full  pb-7 mt-7"></input>
        </span>
        <span className=" font-inter">
          <h5 className="text-[24px] font-inter font-medium">Phone Number</h5>
          <input className="border-b-2 border-gray-600 w-full  pb-7 mt-7"></input>
        </span>
        <span className=" font-inter">
          <h5 className="text-[24px] font-inter font-medium">
      ...
      <div className="mt-10">
        ...
        <span className="flex items-center pl-10 mt-10 bg-green-600 w-71.25 h-12.5 rounded-full">
          <h5 className="text-center text-[24px] text-gray-200 font-medium font-inter">
            Submit Application
          </h5>
        </span>
      </div>
