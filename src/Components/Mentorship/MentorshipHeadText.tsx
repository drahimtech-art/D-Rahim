    ...
    <div className="body-spacing lg:mt-10 mt-5 flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-3">
        <span className="flex gap-2 items-center">
          <span className="relative block min-[800px]:w-10 min-[800px]:h-10 w-9.5 h-9.5  p-1.5  rounded-full">
            <i className="fa fa-check absolute logoMainText text-green-500  -mt-[0.2rem] ml-2 min-[800px]:-mt-0.75 min-[800px]:ml-1.5"></i>
            <span className="block min-[800px]:w-7 min-[800px]:h-7 w-6 h-6  bg-green-500 relative rounded-full">
