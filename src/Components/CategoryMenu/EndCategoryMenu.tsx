      ...
      <div className="flex flex-col mt-5 sm:mt-15 sm:mb-15 mb-27.5 pointer">
        ...
        >
          ...
          <div className="relative ">
            <span
              className="block font-inter font-medium  sm:text-[2.2rem] text-[1rem] max-w-[75%]  sm:pt-10  pt-3 sm:pb-10 pb-3 pl-3 sm:pl-0 dropDownMenuAnimation"
        ...
        >
          ...
          <div className="relative w-full">
            <span
              className="font-inter font-medium sm:text-[2.2rem] text-[1rem]  sm:pt-10 sm:pb-10 pt-3 pb-3 pl-3 sm:pl-0 transition-all dropDownMenuAnimation"
        ...
        >
          ...
          <div className="relative">
            <span
              className="font-inter font-medium sm:text-[2.2rem] text-[1rem] max-w-[80%] sm:pt-10 sm:pb-10 pt-3 pb-3 pl-3 sm:pl-0 dropDownMenuAnimation"
        ...
        >
          ...
          <div className="relative">
            <span
              className="font-inter font-medium sm:text-[2.2rem] text-[1rem]  sm:pt-10 sm:pb-10 pt-3 pb-3 pl-3 sm:pl-0 dropDownMenuAnimation"
