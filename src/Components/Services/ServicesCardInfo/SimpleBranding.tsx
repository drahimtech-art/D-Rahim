              ...
              <div className="flex flex-col min-[1000px]:max-w-254.5 ">
                ...
                <span className="mt-10 flex flex-col  min-[1000px]:gap-9.5 gap-10">
                  <h5 className="font-inter min16Max30px">
                    ...
                    product is still early-stage and needs a clean, credible
                    first impression
                  </h5>
                  <h5 className="font-inter min16Max30px">
                    <strong className="text-green-400 mr-1">*</strong> The idea
                    is clear, but the visual identity feels inconsistent or
                    unpolished
                  </h5>
                  <h5 className="font-inter min16Max30px">
                    <strong className="text-green-400 mr-1">*</strong> The team
                    is preparing to pitch or launch and need to look trustworthy
                    without overinvesting
                  </h5>
                  <h5 className="font-inter min16Max30px">
                    <strong className="text-green-400 mr-1">*</strong> The team
                    needs something simple to align around and present
                    confidently
                  </h5>
                </span>
              </div>
            ...
            <div className="flex  mt-20 min-[1000px]:mt-27.25">
              <div className="flex flex-col min-[1000px]:max-w-254.5 ">
                ...
                <span className="mt-10 flex flex-col gap-10 min-[1000px]:gap-9.5 ">
                  <h5 className="font-inter min16Max30px">
                    <strong className="text-green-400 mr-1">*</strong> 2 visual
                    identity concepts & Brandbook
                  </h5>
                  <h5 className="font-inter min16Max30px">
                    <strong className="text-green-400 mr-1">*</strong>2 pieces
                    of collateral (business card, email template, etc.)
                  </h5>
                </span>
              </div>
            </div>
