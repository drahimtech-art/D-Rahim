  ...
  return (
    <div className="min-[1000px]:pl-10 min-[1000px]:pr-10 min-[1000px]:pt-16 pt-10 pl-5 pr-5 lg:mt-10 mt-5">
      <div className="w-full ">
        ...
        <span className="block min-[1000px]:mt-27.25">
          <h5 className="fontPoppins font-semibold min40Max60px">
            Expand and Scale
          </h5>
          <h5 className="mt-5 text-[30px] font-medium font-inter">
        ...
        <span className="block min-[1000px]:mt-30">
          ...
          <h5 className="mt-5 text-[30px] font-medium font-inter min-[1000px]:max-w-188.25">
