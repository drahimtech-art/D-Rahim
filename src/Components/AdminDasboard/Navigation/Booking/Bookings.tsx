  ...
  return (
    <div className="w-full h-full  ">
      <div className="w-full h-full flex flex-col gap-7">
        {/**Top bar*/}
        <TopBar heading={"Bookings"} subHeading={false} />
        {/**Top Content */}
        <TopContent />
      </div>
      <div className="mt-10 w-full h-full bg-[#FFFFFF] rounded-[20px]">
        ...
        <div className="w-full flex pt-7.5 pb-7.5 pl-2.5 pr-2.5 ">
          ...
          <div className="w-fit h-full flex items-center gap-5.5">
            ...
            <span className="flex w-47.25 gap-2 pl-2 bg-primary-green pr-2 pt-1.5 pb-1.5 text-[#FFFFFF] justify-center items-center border border-gray-500 rounded-[30px]">
        ...
        <div className="w-full h-full">
          ...
          <div className="w-full h-15 border border-[#ebe8e8] bg-[#F5F5F5] grid grid-cols-[15%_30%_15%_10%_10%_10%_10%]">
