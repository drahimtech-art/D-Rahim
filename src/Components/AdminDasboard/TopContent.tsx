function TopContent() {
  return (
    <div className="w-full h-fit grid grid-cols-4 gap-6.75">
      {/**content */}
      <div className="flex flex-col gap-1 w-full pl-5 pr-5 p-3.5 bg-[#FFFFFF] rounded-[14px]">
        <span>
        ...
        <span>
          <h5 className="font-inter font-semibold min28pxMax30">12</h5>
        </span>
      </div>
      {/**content */}
      <div className="flex flex-col gap-1 w-full pl-5 pr-5 p-3.5 bg-[#FFFFFF] rounded-[14px]">
        ...
        <span>
          <h5 className="font-inter font-semibold min28pxMax30">8</h5>
        </span>
      </div>
      {/**content */}
      <div className="flex flex-col gap-1 w-full pl-5 pr-5 p-3.5 bg-[#FFFFFF] rounded-[14px]">
        ...
        <span>
          <h5 className="font-inter font-semibold min28pxMax30">6</h5>
        </span>
      </div>
      {/**content */}
      <div className="flex flex-col gap-1 w-full pl-5 pr-5 p-3.5 bg-[#FFFFFF] rounded-[14px]">
        ...
        <span>
          <h5 className="font-inter font-semibold min28pxMax30">20</h5>
        </span>
      </div>
    </div>
  );
