...
function AdminDasboard() {
  return (
    <div className=" p-10 w-full h-screen bg-[#f8fafa]">
      <div className="flex gap-10 h-fit w-full">
        ...
        <div className="w-full flex flex-col gap-7">
          ...
          <div className="w-full grid grid-cols-2 h-75.75 gap-6.75">
            <div className="w-full h-full pl-5 pr-5 p-3.5 bg-[#FFFFFF] rounded-[20px]">
              ...
              {/** */}
              <div className="mt-4.5 w-full h-full bg-gray-500">
